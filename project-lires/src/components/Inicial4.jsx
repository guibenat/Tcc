...
function App() {
  const [selectedCategory, setSelectedCategory] = useState('5min/dia');
  const categories = ['5min/dia', '10min/dia', '15min/dia', '20min/dia'];
        ...
        <div className="flex-grow overflow-y-auto flex flex-col items-center mt-5">
          ...
          <div className="w-1/2 mx-auto mb-10 h-2 bg-gray-200 rounded-full overflow-hidden relative">
            <div
              ...
              style={{ backgroundImage: 'linear-gradient(90deg, #b081ff, #59b1ff)', width: '50%' }}
            ></div>
          </div>
