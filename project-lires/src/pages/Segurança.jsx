...
// --- Ícones SVG (Atualizados para aceitar 'theme') ---
const EyeIcon = ({ theme }) => (
...
// ATUALIZADO: Aceita 'theme' como prop
  ...
  return (
    <div className="relative">
      <input
        ...
        // ATUALIZADO: Classes de input reagem ao 'theme'
  ...
  return (
    <div className={`content-box w-full ${animationClass}`}>
      ...
      <div className="space-y-6 sm:space-y-8 pr-4 sm:pr-0">
        {/* 4. SEÇÃO LOGIN E SEGURANÇA ATUALIZADA */}
        <div className={`rounded-lg shadow-md p-4 sm:p-6 ${
          ...
          <div className='space-y-4'>
            {/* 6. DISPOSITIVO 1 ATUALIZADO */}
            <div className={`flex flex-col sm:flex-row items-start sm:items-center rounded-xl p-3 sm:p-4 border-2 ${
              theme === 'escuro' 
              ...
              <div className='flex-1'>
                <h2 className={`font-bold text-sm sm:text-base lg:text-lg mb-1 ${
                  theme === 'escuro' ? 'text-purple-400' : 'text-purple-600'
                }`}>Monitor LG 24MK400H-B</h2>
                <p className={`text-xs sm:text-sm mb-1 ${theme === 'escuro' ? 'text-gray-400' : 'text-gray-600'}`}>Conectado via cabo HDMI</p>
                <p className={`text-xs sm:text-sm ${theme === 'escuro' ? 'text-gray-400' : 'text-gray-600'}`}>Último acesso: 20/06/2024</p>
              </div>
            </div>
            {/* 7. DISPOSITIVO 2 ATUALIZADO */}
            <div className={`flex flex-col sm:flex-row items-start sm:items-center rounded-xl p-3 sm:p-4 border-2 ${
              theme === 'escuro' 
              ? 'bg-gray-700 border-gray-600' 
              : 'bg-white border-green-400'
              ...
              <div className='flex-1'>
                ...
                <p className={`text-xs sm:text-sm mb-1 ${theme === 'escuro' ? 'text-gray-400' : 'text-gray-600'}`}>Conectado via Wi-Fi</p>
                <p className={`text-xs sm:text-sm ${theme === 'escuro' ? 'text-gray-400' : 'text-gray-600'}`}>Último acesso: 18/06/2024</p>
              </div>
            </div>
          </div>
        </div>
