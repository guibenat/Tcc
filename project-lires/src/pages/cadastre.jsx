    ...
    return (
        ...
        <strong className='font-bold text-[#7B68EE] text-2xl'>Cadastre-se</strong>
            ...
            <form className='flex flex-col gap-4 p-8 rounded-3xl'>
                ...
                <div className='flex flex-row gap-4 items-center justify-center'>
                    <button type='submit' className='shadow=inner text-[#7B68EE] p-2 rounded-md bg-[linear-gradient(to_right,#F6B8FF,#7B68EE)] text-white'>Google</button>
                    <button type='submit' className='shadow-inner text-[#7B68EE] p-2 rounded-md bg-[linear-gradient(to_right,#F6B8FF,#7B68EE)] text-white'>Facebook</button>
                </div>
