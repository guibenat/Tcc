        ...
        >
          <div className="flex-grow text-left">
            <p className="text-xl font-semibold mb-2" style={{ backgroundImage: 'linear-gradient(90deg, #b081ff, #59b1ff)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              Vamos expandir seu vocabulário em Libras! Aprenda novas formas de cumprimentar e se despedir.
            </p>
            <button
              onClick={onNext}
...
export const saudacoesAvancadasLesson = {
  ...
  title: 'Segunda Aula Prática',
  subtitle: 'Saudações Avançadas',
  steps: [
    {
      type: 'modal-inicio',
      component: Step1
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Qual desses sinais significa Bom dia?" />,
      correctAnswer: 2
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Qual desses sinais significa Boa tarde?" />,
      correctAnswer: 4
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Qual desses sinais significa Boa noite?" />,
      correctAnswer: 0
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Qual desses sinais significa Até logo?" isFinal={true} />,
      correctAnswer: 3
    }
  ]
};