        ...
        >
          <div className="flex-grow text-left">
            <p className="text-xl font-semibold mb-2" style={{ backgroundImage: 'linear-gradient(90deg, #b081ff, #59b1ff)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              Vamos começar a aprender o alfabeto manual em Libras! Hoje você vai dominar as letras A, E, I, O, U.
            </p>
            <button
              onClick={onNext}
...
export const alfabetoLetraALesson = {
  ...
  steps: [
    ...
    { type: 'pergunta', component: (props) => <StepPergunta {...props} questionText="Qual sinal representa a letra A?" />, correctAnswer: 0 },
    { type: 'video', component: StepVideo },
    { type: 'pergunta', component: (props) => <StepPergunta {...props} questionText="Qual sinal representa a letra E?" />, correctAnswer: 2 },
    { type: 'video', component: StepVideo },
    { type: 'pergunta', component: (props) => <StepPergunta {...props} questionText="Qual sinal representa a letra I?" />, correctAnswer: 1 },
    { type: 'video', component: StepVideo },
