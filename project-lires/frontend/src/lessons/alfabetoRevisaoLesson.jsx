        ...
        >
          <div className="flex-grow text-left">
            ...
            <p className="text-xl font-semibold mb-2" style={{ backgroundImage: 'linear-gradient(90deg, #b081ff, #59b1ff)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              Parabéns por chegar até aqui! Vamos revisar tudo que você aprendeu sobre o alfabeto manual em Libras.
            </p>
            <button
              onClick={onNext}
...
export const alfabetoRevisaoLesson = {
  ...
  steps: [
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra A?" />,
      correctAnswer: 0
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra E?" />,
      correctAnswer: 2
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra I?" />,
      correctAnswer: 1
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra B?" />,
      correctAnswer: 1
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra C?" />,
      correctAnswer: 3
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra D?" />,
      correctAnswer: 0
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra O?" />,
      correctAnswer: 4
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra U?" />,
      correctAnswer: 3
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra F?" />,
      correctAnswer: 2
    },
    {
      type: 'video',
    ...
    {
      type: 'pergunta',
      component: (props) => <StepPergunta {...props} questionText="Revisão: Qual sinal representa a letra G?" />,
      correctAnswer: 4
    },
    {
      type: 'video',
