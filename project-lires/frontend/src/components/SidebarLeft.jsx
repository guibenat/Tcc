...
  const navigate = useNavigate(); // O navigate ainda é usado pelos <Link>
...
        // 1. Apaga os dados da sessão do usuário
        localStorage.removeItem('currentUser');
        
        // 2. Força o recarregamento da página para a tela inicial
        // Isso garante que o SettingsContext reinicie e leia
        // que não há NENHUM usuário logado.
