...
// Lógica de verificação diária com suporte ao "Congelar Streak"
...
export function SettingsProvider({ children }) {
    ...
    // Verifica e inicia regeneração ao carregar
    useEffect(() => {
    ...
    // Iniciar Regeneração quando lives chega a 0
    const startLivesRegeneration = () => {
        const regenerationTime = Date.now() + 2 * 60 * 1000; // 2 minutos
    ...
    // Detecta quando lives chega a 0
    useEffect(() => {
    ...
    // Recarregar dados no LOGIN/LOGOUT
    useEffect(() => {
