...
// ... (todos os outros imports de icones, etc. - sem mudança)
...
function Inicial() {
    const { theme, setHasOnboarded, setOnboardingSelections } = useSettings(); // Atualizado da msg anterior
    ...
    // ... (useEffect, allLevels, e outras funções - sem mudança) ...
    useEffect(() => {
    setTypedText('');
...
  };
        ...
        if (step < 4) {
            ...
            setTimeout(() => {
                if (selections.choice === 'Começar do zero') {
                    ...
                    // Navega para a URL com o parâmetro, sem usar 'state'
    ...
    // ... (handlePrevStep, getProgressWidth, getButtonClasses - sem mudança) ...
...
  };
    ...
    return (
        // ... (Todo o JSX do return é IDÊNTICO, sem mudanças) ...
