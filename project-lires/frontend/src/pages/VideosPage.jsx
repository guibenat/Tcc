...
// --- Ícones (ATUALIZADOS para aceitar a prop 'theme') ---
...
// O CloseIcon está no modal escuro, então está OK
...
// --- COMPONENTES DA PÁGINA (ATUALIZADOS) ---
...
// ATUALIZADO: Modal do player (sem alteração, pois já é escuro)
...
// ATUALIZADO: Aceita 'theme' e reage
const ModuleListView = ({ onSelectModule, theme }) => (
...
export default function VideosPage() {
  ...
  return (
    // 2. APLICAR O TEMA AO CONTAINER PRINCIPAL
      ...
      <div className="w-full lg:pl-48 lg:pr-96 flex-grow flex flex-col">
        <main className="px-6 lg:px-12 pt-20 pb-24 lg:pt-8 lg:pb-8 w-full flex-grow flex flex-col">
          <div className={`content-box w-full flex-grow flex flex-col ${enterAnimationClass} ${exitAnimationClass}`}>
            ...
            {/* 3. PASSAR O TEMA PARA OS COMPONENTES FILHOS */}
            {currentView === 'list' && (
              <ModuleListView onSelectModule={handleSelectModule} theme={theme} />
            )}
