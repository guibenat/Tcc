...
// Componente simples pro ícone de 'mostrar senha'
...
const FooterText = ({ theme }) => (
  <div
    className={`text-center text-xs space-y-2 z-10 mt-auto py-4 px-4 ${
...
const getSwalPopupStyles = (theme, type = "info") => {
  ...
  return {
    popup: `font-poppins rounded-2xl ${
      theme === "escuro" ? "bg-gray-800 text-slate-200" : ""
    }`,
    title: titleColor,
    confirmButton:
...
export default function EsqueceuSenha() {
  ...
  // Controla qual etapa do formulário estamos
  const [step, setStep] = useState(1);

  // Estados pra controlar as animações de transição do card
  ...
  // Função pra trocar de etapa com animações
  ...
  const handleFinishReset = () => {
    ...
    const updatedUsersDB = usersDB.map((user) => {
      ...
      return user; // Retorna os outros usuários
    });
        ...
        <main className="w-screen z-10 flex-grow flex flex-col justify-center items-center px-4 py-20">
          ...
          <div className={cardClasses}>
            ...
            {step === 2 && (
              <>
                <p className={descriptionClasses}>
                  Foi enviado um código de 6 números para o seu E-mail, digite
            ...
            {step === 3 && (
              <>
                ...
                <button onClick={handleFinishReset} className={buttonClasses}>
                  Pronto
                </button>
                <p className={linkClasses}>
                  Lembrou sua senha?{" "}
