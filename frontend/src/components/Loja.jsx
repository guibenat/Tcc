...
import coinChestImg from "../assets/coin-chest.png";
import coinBarrelImg from "../assets/coin-barrel.png";
import coinCartImg from "../assets/coin-cart.png";
...
const PixPaymentModal = ({ isOpen, onClose, onConfirm, theme, pack }) => {
  ...
  const pixCopiaECola = `00020126580014br.gov.bcb.pix0136caua.arthur2006@gmail.com5204000053039865405${pack.price.toFixed(
    2
  )}5802BR5910Caua Ramos6009SAO PAULO62070503***6304E5B9`;
...
// Componente principal da página de Loja
...
export default function LojaContent() {
  ...
  const getSwalCustomClasses = () => ({
    ...
    confirmButton:
      "bg-purple-500 hover:bg-purple-600 font-semibold py-2 px-8 rounded-full text-white border-none cursor-pointer transition transform duration-200 hover:scale-105",
  });
  ...
  const baseCardClass =
    "flex flex-col items-center p-4 rounded-xl shadow-lg transition-all transform cursor-pointer hover:scale-105 hover:shadow-xl hover:shadow-yellow-500/20";

  return (
    <Fragment>
      {/* Conteúdo principal da página */}
      <div
        className={`flex flex-col gap-8 w-full content-box ${animationClass}`}
      >
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-800 rounded-2xl p-6 text-white shadow-lg flex flex-col md:flex-row justify-between items-center gap-4 overflow-hidden">
          <div className="flex-1 text-center md:text-left z-10">
            ...
            <h2 className="text-3xl font-bold mb-2">
              Aprenda Libras{" "}
              <span className="text-yellow-300">SEM LIMITES!</span>
            </h2>
            <p className="text-blue-100 text-base mb-6 max-w-md mx-auto md:mx-0">
              Mais conteúdo, mais prática e recursos exclusivos para acelerar
              seu aprendizado.
            </p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div
              onClick={() =>
                setModalData({ isOpen: true, amount: 1200, price: 17.9 })
              }
            ...
            <div
              onClick={() =>
                setModalData({ isOpen: true, amount: 3000, price: 34.0 })
              }
            ...
            <div
              onClick={() =>
                setModalData({ isOpen: true, amount: 6500, price: 51.2 })
              }
